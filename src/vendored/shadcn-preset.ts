// Vendored from shadcn-ui/ui (MIT License).
// Source: https://github.com/shadcn-ui/ui/blob/56161142f1b83f612462772d18883807b5f0d601/packages/shadcn/src/preset/preset.ts
// Sync policy: re-pull when shadcn changes preset constants. See VENDORED.md.
